...
// Cài đặt bộ lọc
$category_ids = [1, 6, 7, 8, 9, 10]; // Bạn có thể thay bằng mảng khác nếu muốn lọc nhiều loại
...
$stmt = $conn->prepare("
   ...
   LEFT JOIN status_products 
   ON products.status_products_id = status_products.status_products_id
   WHERE products.category_id IN (1, 6, 7, 8, 9, 10)
   LIMIT ? OFFSET ?
   ");
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12">
            <section id="search" class="my-5 py-5 ms-2">
                ...
                <form id="searchForm" action="TOPS.php" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-check">
                                    <input type="radio" value="T-SHIRTS" class="form-check-input" name="category" id="category_one">
                                    <label class="form-check-label" for="category_one">T-SHIRTS</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" value="SHIRTS" class="form-check-input" name="category" id="category_two">
                                    <label class="form-check-label" for="category_two">SHIRTS</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" value="SWEATERS & CARDIGANS" class="form-check-input" name="category" id="category_three">
                                    <label class="form-check-label" for="category_three">SWEATERS & CARDIGANS</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" value="SWEATSHIRTS & HOODIES" class="form-check-input" name="category" id="category_four">
                                    <label class="form-check-label" for="category_four">SWEATSHIRTS & HOODIES</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" value="OUTERWEARS" class="form-check-input" name="category" id="category_five">
                                    <label class="form-check-label" for="category_five">OUTERWEARS</label>
                                </div>
                            </div>
...
=======
                        ...
                        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                            <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                <a href="TOPS.php?page=<?php echo $i; ?>&min_price=<?php echo urlencode($min_price); ?>&max_price=<?php echo urlencode($max_price); ?>" class="page-link">
                                    <?php echo $i; ?>
                                </a>
                            </li>
                        <?php endfor; ?>
