                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="product_status" id="product_status" class="form-control" required>
                                        ...
                                        <option
                                            value="<?php echo htmlspecialchars($status_products['status_products_id']); ?>"
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <img class="img-fluid mb-3" src="<?php echo $imageSrc; ?>"
                                    alt="<?php echo ucfirst(str_replace('_', ' ', $imageField)); ?>"
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="product_price_discount" id="product_price_discount"
                                        class="form-control" placeholder="Price Disconut ( Optional )"
                                        value="<?php echo htmlspecialchars($product['product_price_discount']); ?>"
                                        step="0.01">
                                </div>
                            </div>
                        </div>
